...
const ComplianceSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-blue-50 to-white" id="compliance">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Zero Data Retention */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-xl border border-blue-200 hover:shadow-lg transition-all duration-300">
            <div className="mb-3 sm:mb-4">
              <svg className="w-8 h-8 sm:w-10 sm:h-10 text-[var(--highlight-color)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* SOC Compliance */}
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 sm:p-6 rounded-xl border border-purple-200 hover:shadow-lg transition-all duration-300">
            <div className="mb-3 sm:mb-4">
          ...
          {/* Encryption at Rest */}
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 sm:p-6 rounded-xl border border-green-200 hover:shadow-lg transition-all duration-300">
            <div className="mb-3 sm:mb-4">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-50 p-4 sm:p-6 rounded-xl border border-orange-200 hover:shadow-lg transition-all duration-300">
            <div className="mb-3 sm:mb-4">
        ...
        <div
          ref={complianceRef}
          className={`bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-xl border border-gray-200 mb-10 sm:mb-12 md:mb-16 animate-on-scroll animate-scale ${complianceVisible ? 'is-visible' : ''}`}
        >
          <h3
            className="text-xl sm:text-2xl md:text-3xl font-bold text-center text-[#242424] mb-8 sm:mb-10 md:mb-12"
            style={{ fontFamily: 'var(--font-heading)' }}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto">
            {/* GDPR */}
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg border-2 border-blue-200">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[var(--highlight-color)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="text-sm sm:text-base text-[var(--highlight-color)] font-semibold hover:underline inline-flex items-center gap-2 transition-all duration-200"
                    style={{ fontFamily: 'var(--font-ui)' }}
                  >
                    {copiedButton === 'gdpr' ? (
                      <>
            ...
            {/* HIPAA */}
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg border-2 border-purple-200">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="flex-shrink-0">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="text-sm sm:text-base text-purple-600 font-semibold hover:underline inline-flex items-center gap-2 transition-all duration-200"
                    style={{ fontFamily: 'var(--font-ui)' }}
                  >
                    {copiedButton === 'hipaa' ? (
                      <>
