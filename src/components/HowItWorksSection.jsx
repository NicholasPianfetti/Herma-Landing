...
const HowItWorksSection = () => {
  ...
  return (
    <section className="pt-12 sm:pt-16 pb-24 bg-gradient-to-b from-white via-blue-50/30 to-blue-50" id="how-it-works">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p
            className="text-base sm:text-lg md:text-xl text-gray-600 max-w-4xl mx-auto px-2 sm:px-0"
        ...
        <div
          ref={diagramRef}
          className={`bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 lg:p-10 shadow-2xl border border-gray-200 mb-4 sm:mb-6 md:mb-8 animate-on-scroll animate-scale ${diagramVisible ? 'is-visible' : ''}`}
        >

          {/* Privacy Constitution Callout */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-2 sm:p-4 mb-6 sm:mb-8 md:mb-10 border-2 border-[var(--highlight-color)]">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex-shrink-0">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[var(--highlight-color)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-[#242424] mb-2" style={{ fontFamily: 'var(--font-ui)' }}>
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="bg-gray-100 rounded-xl p-6 w-full max-w-md border-2 border-gray-300">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-bold text-lg text-gray-900" style={{ fontFamily: 'var(--font-ui)' }}>
                    User Prompt
                  </h4>
                </div>
                <p className="text-sm text-gray-600 ml-11" style={{ fontFamily: 'var(--font-body)' }}>
                  Request sent with potentially sensitive data
                </p>
              </div>
              {/* Arrow Down */}
              <div className="my-4">
                <svg className="w-8 h-8 text-[var(--highlight-color)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col items-center mb-6 sm:mb-8">
              <div className="bg-gradient-to-br from-[var(--highlight-color)] to-indigo-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 w-full max-w-2xl border-2 sm:border-4 border-blue-300 shadow-2xl relative">
                <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-100 text-xs sm:text-sm mb-2 sm:mb-4" style={{ fontFamily: 'var(--font-body)' }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="bg-white/10 rounded-lg p-3 sm:p-4 backdrop-blur-sm">
                    ...
                    <p className="text-blue-100 text-xs" style={{ fontFamily: 'var(--font-body)' }}>
              ...
              <div className="my-6 flex items-center justify-center gap-4">
                ...
                <span className="text-gray-600 font-semibold text-sm" style={{ fontFamily: 'var(--font-ui)' }}>Routes to optimal destination</span>
                <svg className="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                </svg>
              </div>
            ...
            <div className="mb-4 sm:mb-6 text-center px-2 sm:px-0">
              <p className="text-xs sm:text-sm text-gray-600 italic" style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              {/* On-Prem */}
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 sm:p-6 border-2 border-gray-300 shadow-lg">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  ...
                  <h5 className="font-bold text-sm sm:text-base text-gray-900" style={{ fontFamily: 'var(--font-ui)' }}>On-Premises</h5>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 mb-2 sm:mb-3" style={{ fontFamily: 'var(--font-body)' }}>
                  Ultra-sensitive data stays in your air-gapped infrastructure
                </p>
                <div className="bg-gray-200 rounded px-2 sm:px-3 py-1 text-xs font-semibold text-gray-700 mb-2 inline-block" style={{ fontFamily: 'var(--font-ui)' }}>
                  Maximum Security
                </div>
                <p className="text-xs text-gray-500 italic" style={{ fontFamily: 'var(--font-body)' }}>
                  Your deployed models
                </p>
              </div>

              {/* Private Cloud */}
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-4 sm:p-6 border-2 border-[var(--highlight-color)] shadow-lg">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[var(--highlight-color)] rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                  </div>
                  <h5 className="font-bold text-sm sm:text-base text-[var(--highlight-color)]" style={{ fontFamily: 'var(--font-ui)' }}>Private Cloud</h5>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 mb-2 sm:mb-3" style={{ fontFamily: 'var(--font-body)' }}>
                  Sanitized business data to enterprise private APIs with zero retention
                </p>
                <div className="bg-blue-200 rounded px-2 sm:px-3 py-1 text-xs font-semibold text-[var(--highlight-color)] mb-2 inline-block" style={{ fontFamily: 'var(--font-ui)' }}>
              ...
              {/* Public Cloud */}
              <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-4 sm:p-6 border-2 border-green-400 shadow-lg sm:col-span-2 md:col-span-1">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  ...
                  <h5 className="font-bold text-sm sm:text-base text-green-700" style={{ fontFamily: 'var(--font-ui)' }}>Public Cloud</h5>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 mb-2 sm:mb-3" style={{ fontFamily: 'var(--font-body)' }}>
                  Fully sanitized requests to all models at lowest cost
                </p>
                <div className="bg-green-200 rounded px-2 sm:px-3 py-1 text-xs font-semibold text-green-700 mb-2 inline-block" style={{ fontFamily: 'var(--font-ui)' }}>
                  Maximum Efficiency
                </div>
                <p className="text-xs text-gray-600 italic" style={{ fontFamily: 'var(--font-body)' }}>
                  ChatGPT, Claude, Gemini, etc. — unified under optimized router
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-6 w-full max-w-md border-2 border-green-300">
                <div className="flex items-center gap-3 mb-2">
