...
const About = () => {
  ...
  return (
    <section className="py-[var(--margin-xl)] pt-20 bg-[var(--secondary-bg)] border-t-2 border-[var(--highlight-color)] flex" id="about">
      <div className="container">
        <h2 className="text-[var(--h2-size)] mb-20 text-[var(--highlight-color)] text-center">
          About <span className="font-bold font-[Arial,Helvetica,sans-serif]">HΞRMΛ</span>
        </h2>
        <p className="text-center max-w-[800px] text-[18px] mx-auto mb-[var(--margin-xl)]">
          Herma is an intelligent assistant that helps you find answers, analyze documents, and get things done privately. 
          Currently, you have two choices when using private data with LLMs: 
          either expose private information to the cloud or use custom locally run LLMs that are expensive, complex, and lack the capabilities of cloud-based models. 
          By creating a federated data ecosystem for local AI, we aim to lower costs, expand accessibility, and bring the capabilities of cloud-based AI to a local system.
        ...
        <div className="flex flex-col gap-8 mt-8 w-full" id="features">
          <div className="flex justify-between w-full mb-8 lg:flex-wrap lg:justify-center lg:gap-6 md:gap-6">
            {topRowFeatures.map(feature => (
              <div key={feature.id} className="w-[30%] lg:w-[45%] md:w-full">
                <FeatureCard 
                  icon={feature.icon}
                  title={feature.title}
                  description={feature.description}
